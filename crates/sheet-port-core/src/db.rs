...
use crate::constants::{
    ...
    META_MCP_PORT, META_MCP_TRANSPORT, META_UI_FONT_FAMILY, META_UI_FONT_SCALE, META_UI_LANGUAGE,
...
mod tests {
    ...
    use super::*;
    use crate::constants::{MCP_PORT_DEFAULT, MCP_PORT_MIN, META_MCP_TRANSPORT, META_UI_LANGUAGE};
