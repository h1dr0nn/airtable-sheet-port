...
export const en = {
  ...
  "dashboard.clientUnknownOlder": "Unknown client (older sidecar)",
  "dashboard.clientPending": "Waiting for client",
  "dashboard.clientApp": "This app",
  "dashboard.devBuildBadge": "Dev build",
  "dashboard.sidecarRawClient": "Client: {name}",
  "dashboard.sidecarExePath": "Sidecar: {path}",
  "dashboard.sidecarParentPath": "Started by: {path}",
  "dashboard.sidecarNoDetails": "This sidecar predates client tracking.",
  "dashboard.stopSidecar": "Stop",
  "dashboard.stopSidecarAria": "Stop sidecar PID {pid}",
  "dashboard.stopSidecarTitle": "Stop This Sidecar?",
  "dashboard.stopSidecarDescription":
    "{client} is running sidecar PID {pid} ({version}). Only that process is stopped. The MCP client will reconnect to the new version; in Claude Code, run /mcp and choose Reconnect.",
  "dashboard.restartClaudeDesktop": "Restart Claude Desktop",
  "dashboard.restartingClaudeDesktop": "Restarting...",
  "dashboard.restartClaudeDesktopTitle": "Restart Claude Desktop?",
  "dashboard.restartClaudeDesktopDescription":
    "Claude Desktop will quit and reopen so it starts the current MCP sidecar. Chats and Code tab sessions in progress are interrupted. Claude Code in your terminals is not touched.",
  "dashboard.restartClaudeDesktopConfirm": "Restart",
  ...
  "toast.sidecarStopped": "Sidecar stopped",
  "toast.sidecarStoppedHint": "Reconnect the MCP client to start the new version",
  "toast.sidecarStopError": "Sidecar not stopped",
  "toast.claudeDesktopRestarted": "Claude Desktop restarted",
  "toast.claudeDesktopRestartError": "Claude Desktop not restarted",
...
const vi: Dictionary = {
  ...
  "dashboard.clientUnknownOlder": "Không rõ client (sidecar bản cũ)",
  "dashboard.clientPending": "Đang chờ client kết nối",
  "dashboard.clientApp": "Ứng dụng này",
  "dashboard.devBuildBadge": "Bản dev",
  "dashboard.sidecarRawClient": "Client: {name}",
  "dashboard.sidecarExePath": "Sidecar: {path}",
  "dashboard.sidecarParentPath": "Được mở bởi: {path}",
  "dashboard.sidecarNoDetails": "Sidecar này có từ trước khi app ghi nhận client.",
  "dashboard.stopSidecar": "Dừng",
  "dashboard.stopSidecarAria": "Dừng sidecar PID {pid}",
  "dashboard.stopSidecarTitle": "Dừng sidecar này?",
  "dashboard.stopSidecarDescription":
    "{client} đang chạy sidecar PID {pid} ({version}). Chỉ tiến trình này bị dừng. Client MCP sẽ kết nối lại với bản mới; trong Claude Code, gõ /mcp rồi chọn Reconnect.",
  "dashboard.restartClaudeDesktop": "Khởi động lại Claude Desktop",
  "dashboard.restartingClaudeDesktop": "Đang khởi động lại...",
  "dashboard.restartClaudeDesktopTitle": "Khởi động lại Claude Desktop?",
  "dashboard.restartClaudeDesktopDescription":
    "Claude Desktop sẽ tắt rồi mở lại để chạy sidecar MCP bản hiện tại. Các cuộc trò chuyện và phiên Code đang chạy trong Claude Desktop sẽ bị ngắt. Claude Code trong terminal không bị ảnh hưởng.",
  "dashboard.restartClaudeDesktopConfirm": "Khởi động lại",
  ...
  "toast.sidecarStopped": "Đã dừng sidecar",
  "toast.sidecarStoppedHint": "Kết nối lại client MCP để chạy bản mới",
  "toast.sidecarStopError": "Chưa dừng được sidecar",
  "toast.claudeDesktopRestarted": "Đã khởi động lại Claude Desktop",
  "toast.claudeDesktopRestartError": "Chưa khởi động lại được Claude Desktop",
