...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "font-sans text-[13px] text-ink transition-colors hover:border-ink-faint",
      FOCUS_RING,
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "flex cursor-pointer select-none items-center justify-between gap-2 rounded-md px-2 py-1.5",
      "font-sans text-[13px] text-ink outline-none transition-colors",
